...
def write_csv_headers(output_dir, meta=False):
    ...
    if meta:
        features_headers = ['Accession_id', 'Locus', 'Genus/Species', 'Sequence', 'Region1', 'Region2', 'Region3', 'Start', 'End', 'Best Borosin MT accession', 'Best BBD accession', 'Multiple Borosin MT', 'Multiple BBDs', 'Total Score',"Valid Precursor",] + svm_headers
    else:
