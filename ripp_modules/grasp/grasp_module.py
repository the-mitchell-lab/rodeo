...
def write_csv_headers(output_dir, meta=False):
    ...
    if meta: 
        features_headers = ['Accession_id', 'Locus', 'Genus/Species', 'Precursor peptide','First half', 'Second Half','Start', 'End', 'Best graspetide synthetase', 'Best graspetide synthetase evalue', 'Multiple graspetide synthetases', "Total Score", "Valid Precursor"] + svm_headers 
    else:
