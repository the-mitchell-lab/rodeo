...
Welcome to the new RODEO! Exhaustive documentation on how RODEO should be used can be found on the [RODEO website.](http://www.ripp.rodeo/index.html) The explanation below is a brief summary of how to use RODEO. Please report any bugs either via GitHub or by contacting the developers directly.
